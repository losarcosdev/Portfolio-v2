...
export const About = () => {
  return (
    <div className="flex flex-col items-center h-screen justify-center overflow-hidden from-black via-zinc-600/20 to-black md:max-w-5xl container mx-auto px-2 md:p-0">
      <div className="my-16">
      ...
      <div className="my-16 text-center p-1">
        <h2 className="text-zinc-500 w-full md:w-[700px]">
          I&apos;m a Full Stack Developer based in Argentina, fueled by a deep passion
          for crafting captivating and visually appealing web interactions. I
          continuously aim to deliver top-notch code while designing
